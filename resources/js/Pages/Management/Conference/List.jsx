            ...
            >
                ...
                >
                    <div className="flex items-center gap-5">
                        ...
                        <div>
                            <h1 className="text-2xl font-black text-slate-900 tracking-tight">Your Conferences</h1>
                            <p className="text-slate-500 font-medium">Manage and organize your academic event proceedings.</p>
                        </div>
                    </div>
                    <Link
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-slate-50/50 border-b border-slate-100">
                                    <th className="px-8 py-5 font-black text-slate-500 uppercase text-[10px] tracking-[0.2em]">Conference Information</th>
                            ...
                            <tbody className="divide-y divide-slate-50">
                                {conferences.length > 0 ? conferences.map(conf => (
                                    <tr key={conf.id} className="hover:bg-emerald-50/30 transition-colors group">
                                    ...
                                    <tr>
                                        <td colSpan="3" className="px-8 py-20 text-center">
                                            <div className="flex flex-col items-center gap-4">
                                                ...
                                                <div>
                                                    <p className="text-lg font-bold text-slate-900">No conferences found</p>
                                                    <p className="text-slate-500 font-medium">Create your first conference publication to get started.</p>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
