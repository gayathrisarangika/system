...
export default function Form({ symposium = null, pre_filled_title = '' }) {
    ...
    return (
        <BackendLayout title={symposium ? 'Edit Symposium' : 'Create Symposium'}>
            ...
            <h1 className="text-2xl font-bold mb-8 text-slate-900 border-b pb-4">{symposium ? 'Edit' : 'Create'} Symposium</h1>
            <form onSubmit={submit} className="space-y-6">
                ...
                <button className="w-full bg-blue-600 text-white px-6 py-3 rounded-xl font-bold hover:bg-blue-700 transition shadow-lg shadow-blue-500/20 mt-8" disabled={processing}>Save Symposium</button>
            </form>
            </div>
        </BackendLayout>
    );
