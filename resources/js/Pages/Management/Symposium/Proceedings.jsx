...
export default function Proceedings({ symposium, proceedings }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(`/editor/symposium/${symposium.id}/proceedings`, {
            onSuccess: () => reset()
        });
    };
    ...
    return (
        <div className="p-8 max-w-5xl mx-auto">
            ...
            <h1 className="text-2xl font-bold mb-6">Proceedings - {symposium.symposium_title}</h1>
