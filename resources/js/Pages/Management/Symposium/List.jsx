    ...
    return (
        <div className="p-8 bg-gray-50 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center mb-10 bg-white p-6 rounded-xl shadow-sm border border-gray-200 gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 font-serif">Your Symposiums</h1>
                    <p className="text-gray-500">Manage your symposium publications and abstract books</p>
                </div>
                <Link href="/editor/symposium/create" className="bg-blue-900 text-white px-6 py-2 rounded-lg font-bold hover:bg-blue-800 transition">Add Symposium</Link>
            </div>
