                    ...
                    <aside className="lg:w-80 flex flex-col gap-8">
                        <div className="bg-blue-900 text-white p-6 rounded-lg shadow-md">
                            ...
                            <ul className="space-y-3 text-blue-100">
                                {publication.for_authors_url && (
                                    <li><a href={publication.for_authors_url} target="_blank" className="hover:text-white transition flex items-center gap-2 font-bold">Author Guidelines</a></li>
                                )}
                                {publication.for_reviewers_url && (
                                    <li><a href={publication.for_reviewers_url} target="_blank" className="hover:text-white transition flex items-center gap-2 font-bold">Reviewer Guidelines</a></li>
                                )}
                                <li><Link href={`/${type}/${publication.id}/contact`} className="hover:text-white transition flex items-center gap-2 font-bold">Contact Us</Link></li>
                            </ul>
                        </div>
                    </aside>
                </div>
