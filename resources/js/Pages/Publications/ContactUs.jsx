                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            ...
                            <div className="space-y-6">
                                ...
                                >
                                    ...
                                    <a href="https://www.sab.ac.lk" target="_blank" className="font-black text-slate-900 hover:text-blue-600 transition-colors flex items-center gap-2">
                                        www.sab.ac.lk <ExternalLink size={14} />
                                    </a>
                                </motion.div>
                            </div>
                        </div>
