                    ...
                    <div className="flex-1 bg-white p-8 rounded-lg shadow-sm border border-gray-200">
                        ...
                        {journal.contact_us && (
                            <section className="mb-10" id="contact-us">
                                ...
                                <div className="mt-4">
                                    <Link href={`/journal/${journal.id}/contact`} className="inline-flex items-center gap-2 bg-gray-100 text-blue-900 px-6 py-3 rounded-lg font-bold hover:bg-gray-200 transition border border-gray-300">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
